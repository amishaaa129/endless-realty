      ...
      <div className="container mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
          <div className="bg-white shadow-md rounded-lg p-6">
            <h2 className="text-2xl font-semibold text-gray-800 mb-2">Associate 1</h2>
            <p className="text-gray-600">
              A leading real estate developer specializing in luxury apartments and villas.
            </p>
          </div>
          <div className="bg-white shadow-md rounded-lg p-6">
            <h2 className="text-2xl font-semibold text-gray-800 mb-2">Associate 2</h2>
            <p className="text-gray-600">
              Experts in commercial property development with a focus on sustainability.
            </p>
          </div>
          <div className="bg-white shadow-md rounded-lg p-6">
            <h2 className="text-2xl font-semibold text-gray-800 mb-2">Associate 3</h2>
            <p className="text-gray-600">
