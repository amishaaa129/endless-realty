    ...
    <>
      ...
      <section className="founder-story-section flex justify-end">
        <div className="founder-story text-left max-w-3xl w-full mr-4">
          <h2 className="text-3xl font-bold mb-6 text-gray-800">Endless Realty's Story</h2>
          ...
          <ul>
            <p><strong>Local Expertise, Personal Touch:</strong> इंदौर का प्रॉपर्टी मार्केट तेजी से Grow कर रहा है और Prices रोज़ बढ़ रहे हैं। ऐसे में हम आपको clarity, confidence और control देते हैं — ताकि आप सही decision ले सकें।</p>
            <p><strong>One-stop full service:</strong> चाहे आपको Property खरीदनी हो या बेचनी हो या mortgage की मदद, Interior Designing से लेकर Property Manage करना हो — हम सब कुछ एक ही जगह पर उपलब्ध करते हैं।</p>
            <p><strong>Smart data + Local knowledge:</strong> हम सिर्फ अंदाज़े से नहीं, Market के Data के साथ काम करते हैं — जैसे की Valuation Reports और Price Trends — ताकि आप पूरी जानकारी के साथ जल्दी decision ले सकें।</p>
            <p><strong>Developer + Consultant का Experience:</strong> हमने 200+ घर और 6 township projects खुद बनाए हैं। इसलिए हमें Development की गहराई से समझ है, और Consultancy का भी पूरा अनुभव।</p>
            <p><strong>Trust & Transparency:</strong> जहाँ आज के market में कीमत अक्सर ज्यादा बताई जाती हैं और trust की कमी होती है, वहां Endless Realty का मकसद है साफ-सुथरी सलाह देना और लंबे समय तक भरोसे का रिश्ता बनाए रखना।</p>
          </ul>
